...
<body>
  ...
  <main class="prod">
      ...
      <img src="imagens/cafe5.png" alt="HND" >

      <div class="desc">
        <h1> CAFÉ PRA VALER TRADICIONAL 500G</h1>
      <h2>R$10,99</h2>
      ...
      <div class="rec">
        ...
        <div class="item">
          ...
          <img src="imagens/cafe4.png" alt="Madrina" style="width:100%">
        </a>
          <h1 class="shop-item-title">Café Madrinas</h1>
          <p class="preco">R$39.99</p>
          <p><button>Adicionar</button></p>
        </div>
        <div class="item">
          <a href="pravaler.html">
          <img src="imagens/cafe5.png" alt="Pilão" style="width:100%">
        </a>
          <h1 class="shop-item-title">Café Pra valer</h1>
        ...
        <div class="item">
          ...
          <h1 class="shop-item-title">Gourmet HND</h1>
